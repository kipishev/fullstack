...
<!--            <tr v-if='!products.length' >
                <td class="text-center" colspan="5">Корзина пока пуста, начните <a href="/">покупать!</a></td>
            </tr>-->
            <tr>
                <td colspan="4" class="text-end">Итого</td>
                <td><strong><!--{{ Number(summ).toFixed(2) }}--></strong></td>
            </tr>
            </tbody>
        </table>
    ...
    methods: {
        ...
        createOrder () {
            ...
            const params = {
                ...
                products: JSON.parse(localStoreage.getItem('cart')),
            }
