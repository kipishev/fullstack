...
?>
    ...
    <form method="POST" enctype="multipart/form-data" action="../../actions/admin/createProducts.php">
        <input value="<?= $_SESSION['lastProductCreate']['name'] ?? '' ?>" class="form-control mb-2" name="name" placeholder="Наименование продуктов">
        ...
        <select class="form-control mb-2" name="category_id">
            <?php
                ...
                if (!$lastCategoryId) {
                    echo '<option disabled selected>-- Выберете категорию --</option>';
                }
