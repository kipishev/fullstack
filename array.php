...
// Пример нечислового (ассоциативного) массива
echo '<br>';
$person = [
    'name' => 'Andrei',
    'age' => 36,
...
$output = '';
// первое, что нам нужно сделать - это объявить пустую строку, чтобы потом к ней приращиватьзначения
...
// Есть и обратная функция explode, которая из строки создает массив
