...
require 'funcs.php';
// Данная конструкция требует чтобы файл существовал, иначе выведет ошибку
test();

require 'funcs.php';
require 'funcs.php';
test();
// Вывод двух одинаковых функций также вызовет ошибку

require_once 'funcs.php';
/* Данная конструкция позволяет подключить файл один раз и больше не подключать если будет встречаться,
что исключит вывод ошибки */
test();

include 'funcs.php';
/* Аналогично подключению require, но не выведет фатальную ошибку если файла не существует (выведет
только предупреждение) */
test();
/* Но если мы попытаемся вызвать подключаемую несуществующую функцию на исполнение,
то получим фатальную ошибку */
